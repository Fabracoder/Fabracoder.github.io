 ...
 
     {
         for (x = 0; x < 10; x++) 
         {
                      for (y = 0; y < 10; y++) 
                      {
                          ...
                          for (z = 0; z < 10; z++) 
                          { 
//                              console.log(":"+x +":"+y +":"+z +";"+ PerlinNoise.noise(x,y,z) );
                                console.log(":"+x +":"+y +":"+z +";"+ SeetNoise.noise(new THREE.Vector3(x,y,z),413,2) );
...
function createRulerGrid()
{
    ...
    for(x=-segments/2;x<segments/2;x++){
    for(y=-segments/2;y<segments/2;y++){
    for(z=-segments/2;z<segments/2;z++){
    ...
    {
        colors[(s*3)+0]=30; 
        colors[(s*3)+1]=30;  //todo: figure a way to color the mesh for better counting
        colors[(s*3)+2]=30; 
    }
    }}}
